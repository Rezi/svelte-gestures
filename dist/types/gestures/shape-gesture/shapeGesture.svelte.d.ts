...
export declare function useShapeGesture(inputParameters: () => Partial<ShapeGestureParameters>, handler: (e: ShapeCustomEvent) => void, baseHandlers?: Partial<Record<EventTypeName, (gestureEvent: GestureCustomEvent) => void>>): {
