...
export declare function usePress(inputParameters: () => Partial<PressParameters>, handler: (e: PressCustomEvent) => void, baseHandlers?: Partial<Record<EventTypeName, (gestureEvent: GestureCustomEvent) => void>>): {
